...
import io.github.droidkaigi.confsched.feature.about.component.DoodleCanvasView
...
import io.github.droidkaigi.confsched.feature.about.generated.resources.doodle_title
...
private fun DoodleScreenPreview(
    ...
    KaigiPreviewTheme(colorScheme) {
        DoodleScreen(
            uiState = DoodleScreenUiState(savedDoodle = Doodle.fake(), isSaving = false),
            onSaveClick = {},
            onBackClick = {},
        )
    }
...
private fun DoodleScreenEmptyPreview(
    ...
    KaigiPreviewTheme(colorScheme) {
        DoodleScreen(
            uiState = DoodleScreenUiState(savedDoodle = Doodle.Empty, isSaving = false),
            onSaveClick = {},
            onBackClick = {},
        )
    }
