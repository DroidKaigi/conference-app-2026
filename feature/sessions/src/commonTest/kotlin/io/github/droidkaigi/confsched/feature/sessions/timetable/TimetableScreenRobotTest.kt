...
class TimetableScreenRobotTest : RobotTest() {
    ...
    private val sampleTimetable = Timetable(
        items = persistentListOf(
            ...
            testTimetableItem(id = "d1b", title = "Day1 B", room = SessionRoom.NARWHAL, speaker = "Sp2", language = Language.ENGLISH, day = DroidKaigi2026Day.Day1, startsAt = "11:00", endsAt = "11:40"),
            testTimetableItem(id = "d1c", title = "Day1 C", room = SessionRoom.NARWHAL, speaker = "Sp4", language = Language.ENGLISH, day = DroidKaigi2026Day.Day1, startsAt = "12:00", endsAt = "12:40"),
            testTimetableItem(id = "d1d", title = "Day1 D", room = SessionRoom.NARWHAL, speaker = "Sp5", language = Language.ENGLISH, day = DroidKaigi2026Day.Day1, startsAt = "13:00", endsAt = "13:40"),
            testTimetableItem(id = "d1e", title = "Day1 E", room = SessionRoom.NARWHAL, speaker = "Sp6", language = Language.ENGLISH, day = DroidKaigi2026Day.Day1, startsAt = "14:00", endsAt = "14:40"),
