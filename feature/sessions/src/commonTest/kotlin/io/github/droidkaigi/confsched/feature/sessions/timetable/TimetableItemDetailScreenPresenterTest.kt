...
class TimetableItemDetailScreenPresenterTest {
    ...
    private val timetable = Timetable(
        items = persistentListOf(
            ...
            testTimetableItem(id = "d1c", title = "Day1 C", room = Room.PANDA, speaker = "Sp3", language = Language.ENGLISH, day = DroidKaigi2026Day.Day1, startsAt = "11:00", endsAt = "11:40"),
        ),
    )
    ...
    fun the_state_carries_the_session_its_neighbours_and_the_memo() {
        runPresenterTest(
            ...
            assertEquals(listOf("d1b"), initial.sameSlotItems.map { it.id.value })
    ...
    fun actions_toggle_the_description_and_reach_the_mutations() {
        runPresenterTest(
            ...
            send(TimetableItemDetailScreenAction.ToggleDescription)
