...
internal fun SessionDescriptionSection(
    ...
    // Only a description the collapsed height cuts off earns the control that uncuts it.
    ...
    Column(
        ...
        if (isTruncated) {
            KaigiButton(onClick = onToggleClick, seed = seed, modifier = Modifier.fillMaxWidth()) {
                Text(
