 ...
 */
internal enum class LanternStyle(
    val hangingCord: Dp,
    val size: DpSize,
    val pathData: String,
    ...
    Type0(
        ...
        viewBox = Size(32f, 41f),
        ribOffsetY = 10.0f,
    ),
    Type1(
        hangingCord = 26.dp,
        size = DpSize(27.dp, 36.dp),
        ...
        viewBox = Size(30f, 39f),
        ribOffsetY = 11.0f,
    ),
    Type2(
        hangingCord = 11.dp,
        size = DpSize(30.dp, 41.dp),
...
internal fun Lantern(
    ...
    val capPath = remember {
        PathParser().parsePathString(CAP_PATH_DATA).toPath()
    }
